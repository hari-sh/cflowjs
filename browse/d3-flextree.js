...
var Node$2 = hierarchy.prototype.constructor;
...
function flextree(options) {
  ...
  Object.assign(layout, {
    ...
    dump: function dump(tree) {
      var nodeSize = accessor('nodeSize');
      var dumpNode = function dumpNode(i0) {
        return function (node) {
          ...
          var kidDumps = kids.length === 0 ? ' ' : ',' + i1 + 'children: [' + i2 + kids.map(dumpNode(i2)).join(i2) + i1 + '],' + i0;
